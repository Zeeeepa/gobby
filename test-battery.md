...
| 7 | #10173 | `invoke_pipeline` passes dict instead of string to sub-pipeline arguments | Filed — not yet fixed |
| 8 | #10174 | Merge agent should stash dirty `.gobby/` sync files before merging | Filed — not yet fixed |
