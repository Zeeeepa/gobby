...
def create_mcp_router() -> APIRouter:
    ...
    # Register execution endpoint from endpoints/execution.py
    ...
    # Register execution endpoints from endpoints/execution.py
    ...
    # Register MCP proxy endpoint from endpoints/execution.py
