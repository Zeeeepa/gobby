...
class SessionSource(str, Enum):
    ...
    AUTONOMOUS_SDK = "autonomous_sdk"  # Claude SDK autonomous agents (AutonomousRunner)
    CODEX_AUTONOMOUS = "codex_autonomous"  # Codex autonomous agents (CodexAutonomousRunner)
