...
For rescue work, run diagnosis and fix-oriented recipes in write mode by default
(`codex exec -s workspace-write`) unless the user explicitly asked for read-only behavior.
