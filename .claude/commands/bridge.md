---
description: Process Drawbridge UI annotation tasks from the Chrome extension
---
...
**FOR EACH TASK:**
1. **BEFORE implementing**: Update JSON status to `"doing"`
2. **Implement** the code change
3. **AFTER implementing**: Update JSON status to `"done"` + MD checkbox to `[x]`

**NEVER skip the "doing" status. ALWAYS update to "doing" before starting work.**
