...
class TestFinders:
    ...
    def test_find_mcp_config(self, tmp_path):
    ...
    def test_build_gobby_mcp_entry(self):
...
class TestHookResponseConverters:
    ...
    def test_post_tool_output(self):
