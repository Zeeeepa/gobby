"""
Tests for autonomous-task step workflow and related functionality.
...
# =============================================================================
# Test autonomous-task Workflow Loading
# =============================================================================


class TestAutonomousTaskWorkflowLoading:
    """Tests for loading the autonomous-task workflow."""

    def test_workflow_can_be_loaded(self):
        """autonomous-task.yaml workflow can be loaded."""
        ...
        workflow = loader.load_workflow("autonomous-task")

        assert workflow is not None
        assert workflow.name == "autonomous-task"
        assert workflow.type == "step"

    def test_workflow_has_expected_steps(self):
        """autonomous-task workflow has work and complete steps."""
        workflow_dir = Path(__file__).parent.parent.parent / "src/gobby/install/shared/workflows"
        loader = WorkflowLoader(workflow_dirs=[workflow_dir])
    ...
    def test_workflow_has_exit_condition(self):
        """autonomous-task workflow has exit_condition defined."""
        workflow_dir = Path(__file__).parent.parent.parent / "src/gobby/install/shared/workflows"
        loader = WorkflowLoader(workflow_dirs=[workflow_dir])
    ...
    def test_workflow_has_premature_stop_handler(self):
        """autonomous-task workflow has on_premature_stop defined."""
        workflow_dir = Path(__file__).parent.parent.parent / "src/gobby/install/shared/workflows"
        loader = WorkflowLoader(workflow_dirs=[workflow_dir])
