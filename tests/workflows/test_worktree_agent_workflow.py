...
class TestWorktreeAgentWorkflowLoading:
    ...
    def test_worktree_agent_workflow_loads(self, workflow_loader_with_install_dir) -> None:
    ...
    def test_worktree_agent_has_work_step(self, workflow_loader_with_install_dir) -> None:
...
class TestWorktreeAgentAllowedTools:
    ...
    def test_allows_get_task(self, workflow_loader_with_install_dir) -> None:
    ...
    def test_allows_update_task(self, workflow_loader_with_install_dir) -> None:
    ...
    def test_allows_close_task(self, workflow_loader_with_install_dir) -> None:
    ...
    def test_allows_memory_tools(self, workflow_loader_with_install_dir) -> None:
...
class TestWorktreeAgentBlockedTools:
    ...
    def test_blocks_list_tasks(self, workflow_loader_with_install_dir) -> None:
    ...
    def test_blocks_create_task(self, workflow_loader_with_install_dir) -> None:
    ...
    def test_blocks_expand_task(self, workflow_loader_with_install_dir) -> None:
    ...
    def test_blocks_gobby_agents_tools(self, workflow_loader_with_install_dir) -> None:
    ...
    def test_blocks_gobby_worktrees_tools(self, workflow_loader_with_install_dir) -> None:
...
class TestWorktreeAgentWorkflowSettings:
    ...
    def test_has_description(self, workflow_loader_with_install_dir) -> None:
