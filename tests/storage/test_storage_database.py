...
class TestLocalDatabase:
    ...
    def test_artifact_manager_property_exists(self, temp_db: LocalDatabase) -> None:
        ...
        manager = temp_db.artifact_manager
    ...
    def test_artifact_manager_is_lazily_initialized(self, temp_dir: Path) -> None:
        ...
        # Manager should be None before first access
        assert db._artifact_manager is None

        # Access property to trigger initialization
        manager = db.artifact_manager

        # Manager should now be set
        assert db._artifact_manager is not None
        assert manager is db._artifact_manager
    ...
    def test_close_cleans_up_artifact_manager(self, temp_dir: Path) -> None:
        ...
        # Access manager to initialize it
        _ = db.artifact_manager
        assert db._artifact_manager is not None
