...
class TestSaveRule:
    def test_save_bundled_rule(self, rule_store) -> None:
    ...
    def test_save_user_rule(self, rule_store) -> None:
        rule = rule_store.save_rule(
            name="no_push",
            tier="user",
    ...
    def test_save_project_rule(self, rule_store, project_id: str) -> None:
        rule = rule_store.save_rule(
            name="require_tests",
            tier="project",
    ...
    def test_save_with_source_file(self, rule_store) -> None:
        rule = rule_store.save_rule(
            name="from_file",
            tier="bundled",
    ...
    def test_save_upsert_existing(self, rule_store) -> None:
    ...
    def test_save_same_name_different_tiers(self, rule_store, project_id: str) -> None:
    ...
    def test_save_invalid_tier(self, rule_store) -> None:
    ...
    def test_save_project_tier_requires_project_id(self, rule_store) -> None:
...
class TestGetRule:
    def test_get_bundled_rule(self, rule_store) -> None:
        rule_store.save_rule(
    ...
    def test_get_nonexistent(self, rule_store) -> None:
        assert rule_store.get_rule("nonexistent") is None

    def test_tier_precedence_user_over_bundled(self, rule_store) -> None:
    ...
    def test_tier_precedence_project_over_user(self, rule_store, project_id: str) -> None:
    ...
    def test_get_without_project_id_skips_project_tier(self, rule_store, project_id: str) -> None:
    ...
    def test_get_specific_tier(self, rule_store) -> None:
...
class TestListRules:
    def test_list_empty(self, rule_store) -> None:
        assert rule_store.list_rules() == []

    def test_list_all(self, rule_store) -> None:
    ...
    def test_list_by_tier(self, rule_store, project_id: str) -> None:
        rule_store.save_rule(name="r1", tier="bundled", definition={"reason": "a", "action": "block"})
        rule_store.save_rule(name="r2", tier="user", definition={"reason": "b", "action": "warn"})
    ...
    def test_list_by_project_id(self, rule_store, project_id: str) -> None:
        pid2 = str(uuid.uuid4())
    ...
    def test_list_sorted_by_name(self, rule_store) -> None:
...
class TestGetRulesByTier:
    def test_get_rules_by_tier(self, rule_store) -> None:
        rule_store.save_rule(name="r1", tier="bundled", definition={"reason": "a", "action": "block"})
    ...
    def test_get_rules_by_tier_empty(self, rule_store) -> None:
...
class TestDeleteRule:
    def test_delete_existing(self, rule_store) -> None:
    ...
    def test_delete_nonexistent(self, rule_store) -> None:
        assert rule_store.delete_rule(str(uuid.uuid4())) is False

    def test_delete_by_name_and_tier(self, rule_store) -> None:
    ...
    def test_delete_by_name_nonexistent(self, rule_store) -> None:
