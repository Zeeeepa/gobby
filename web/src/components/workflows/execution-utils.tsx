...
export function StatusBadge({ status }: { status: string }) {
  return <span className={`pipeline-badge pipeline-badge--${status}`}>{STATUS_LABELS[status] || status}</span>
}
...
export function StepDisplay({ step, index }: { step: StepData; index: number }) {
